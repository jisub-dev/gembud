...
export function PasswordModal({ onConfirm, onCancel, inviteCode }: PasswordModalProps) {
  const [password, setPassword] = useState('');
  const isInviteMode = Boolean(inviteCode);
      ...
      <div className="bg-[#18181b] border-2 border-gray-700 rounded-lg p-6 max-w-sm w-full mx-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3">
            ...
            <button
              type="submit"
              disabled={!isInviteMode && !password.trim()}
